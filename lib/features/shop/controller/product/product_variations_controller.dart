...
class ProductVariationController extends GetxController {
  ...
  List<Map<ProductVariationModel, TextEditingController>> stockControllerLists =
      [];
  List<Map<ProductVariationModel, TextEditingController>> priceControllerLists =
      [];
  List<Map<ProductVariationModel, TextEditingController>>
      salePriceControllerLists = [];
  List<Map<ProductVariationModel, TextEditingController>>
      descriptionControllerLists = [];

  final attributesController = Get.put(ProductAttributesController());

  // Function to initialize variation controllers
  void initializeVariationControllers(List<ProductVariationModel> variations) {
    // Clean existing lists
    stockControllerLists.clear();
    priceControllerLists.clear();
    salePriceControllerLists.clear();
    descriptionControllerLists.clear();
    ...
    for (var variation in variations) {
      ...
      stockControllerLists.add(stockControllers);
      ...
      priceControllerLists.add(priceControllers);
      ...
      salePriceControllerLists.add(salePriceControllers);
      ...
      descriptionControllerLists.add(descriptionControllers);
    }
  }
